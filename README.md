# COMP2160 Coding Standards

Resources in this repository:
* **Style Guide.md** - A guide to C# naming conventions and other style requirements for the unit.
* **Code Patterns.md** - A guide to Unity development patterns for the unit.
